...
// src/types.ts
var MigrationPhase = /* @__PURE__ */ ((MigrationPhase2) => {
  MigrationPhase2[MigrationPhase2["Setup"] = 0] = "Setup";
  MigrationPhase2[MigrationPhase2["ActiveMigration"] = 1] = "ActiveMigration";
  MigrationPhase2[MigrationPhase2["GracePeriod"] = 2] = "GracePeriod";
  MigrationPhase2[MigrationPhase2["Finalized"] = 3] = "Finalized";
  return MigrationPhase2;
})(MigrationPhase || {});
var SdkErrorCode = /* @__PURE__ */ ((SdkErrorCode2) => {
  SdkErrorCode2["PROJECT_NOT_FOUND"] = "PROJECT_NOT_FOUND";
  SdkErrorCode2["PROJECT_PAUSED"] = "PROJECT_PAUSED";
  SdkErrorCode2["MIGRATION_WINDOW_CLOSED"] = "MIGRATION_WINDOW_CLOSED";
  SdkErrorCode2["INVALID_PHASE"] = "INVALID_PHASE";
  SdkErrorCode2["ACCOUNT_NOT_FOUND"] = "ACCOUNT_NOT_FOUND";
  SdkErrorCode2["INSUFFICIENT_BALANCE"] = "INSUFFICIENT_BALANCE";
  SdkErrorCode2["INVALID_MINT"] = "INVALID_MINT";
  SdkErrorCode2["TRANSACTION_FAILED"] = "TRANSACTION_FAILED";
  SdkErrorCode2["SIMULATION_FAILED"] = "SIMULATION_FAILED";
  SdkErrorCode2["RPC_ERROR"] = "RPC_ERROR";
  SdkErrorCode2["RATE_LIMIT"] = "RATE_LIMIT";
  SdkErrorCode2["INVALID_AMOUNT"] = "INVALID_AMOUNT";
  SdkErrorCode2["INVALID_PUBLIC_KEY"] = "INVALID_PUBLIC_KEY";
...
function loadIdl(networkOverride) {
  ...
  const programId = new web3_js.PublicKey(programAddress);
  const idl = {
    ...normalizedSource,
...
async function getProgram(connectionOrProvider, options = {}) {
  ...
  const provider = connectionOrProvider instanceof web3_js.Connection ? new anchor.AnchorProvider(
  ...
  try {
    ...
    if (onchainIdl) {
      return new anchor.Program(onchainIdl, provider);
    }
  } catch (error) {
    console.warn(
...
function getMftMintPda(projectId, options = {}) {
  const programId = getProgramId(options.network);
  return web3_js.PublicKey.findProgramAddressSync([SEEDS.MFT_MINT, Buffer.from(projectId)], programId);
}
function getLpVaultPda(projectId, options = {}) {
  const programId = getProgramId(options.network);
  return web3_js.PublicKey.findProgramAddressSync([SEEDS.LP_VAULT, Buffer.from(projectId)], programId);
}
function getUserMigrationPda(user, projectId, options = {}) {
  const programId = getProgramId(options.network);
  return web3_js.PublicKey.findProgramAddressSync(
...
function getRegistryPda(options = {}) {
  const programId = getProgramId(options.network);
  return web3_js.PublicKey.findProgramAddressSync([SEEDS.PROJECT_REGISTRY], programId);
}
function getPlatformConfigPda(options = {}) {
  const programId = getProgramId(options.network);
  return web3_js.PublicKey.findProgramAddressSync([SEEDS.PLATFORM_CONFIG], programId);
}
function getPlatformFeeVaultPda(platformConfig, quoteTokenMint, options = {}) {
  const programId = getProgramId(options.network);
  return web3_js.PublicKey.findProgramAddressSync(
...
function getUserAta(user, mint, tokenProgram = splToken.TOKEN_PROGRAM_ID) {
...
var Throttle = class {
  ...
  async wait() {
    ...
    if (elapsed < this.minDelay) {
      const delay2 = this.minDelay - elapsed;
...
async function getBalances(projectId, user, connection, project, options = {}) {
  ...
  try {
    ...
    const oldTokenProgram = splToken.TOKEN_PROGRAM_ID;
    await rpcThrottle.wait();
    ...
    let mftBalance = 0n;
    try {
      const mftAta = getUserAta(user, loadedProject.mftMint, splToken.TOKEN_PROGRAM_ID);
...
function getErrorTitle(code) {
  switch (code) {
    ...
    case "PROJECT_PAUSED" /* PROJECT_PAUSED */:
    case "MIGRATION_WINDOW_CLOSED" /* MIGRATION_WINDOW_CLOSED */:
    ...
    case "INVALID_MINT" /* INVALID_MINT */:
      return "Account Error";
    case "TRANSACTION_FAILED" /* TRANSACTION_FAILED */:
    case "SIMULATION_FAILED" /* SIMULATION_FAILED */:
...
function getDefaultRecoveryActions(code) {
  switch (code) {
    case "RPC_ERROR" /* RPC_ERROR */:
    case "RATE_LIMIT" /* RATE_LIMIT */:
      return [
...
async function buildMigrateTx(connection, user, projectId, amount, project, options = {}) {
  try {
    ...
    const userMftAta = splToken.getAssociatedTokenAddressSync(
      project.mftMint,
      user,
      false,
...
async function buildClaimMftTx(connection, user, projectId, mftAmount, project, _options = {}) {
  try {
    if (mftAmount <= 0n) {
      throw new SdkError(
        "INVALID_AMOUNT" /* INVALID_AMOUNT */,
    ...
    const newTokenProgram = splToken.TOKEN_PROGRAM_ID;
    const userMftAta = splToken.getAssociatedTokenAddressSync(
      project.mftMint,
      user,
      false,
    ...
    const userNewTokenAta = splToken.getAssociatedTokenAddressSync(
...
function adjustForDecimals(amount, fromDecimals, toDecimals) {
...
exports.Cache = Cache;
exports.MigrationPhase = MigrationPhase;
exports.PROGRAM_ID = PROGRAM_ID;
exports.SdkError = SdkError;
exports.SdkErrorCode = SdkErrorCode;
exports.Throttle = Throttle;
exports._resetCache = _resetCache;
exports.buildClaimMftTx = buildClaimMftTx;
exports.buildMigrateTx = buildMigrateTx;
...
exports.getMftMintPda = getMftMintPda;
exports.getNewTokenVaultPda = getNewTokenVaultPda;
exports.getOldTokenVaultPda = getOldTokenVaultPda;
exports.getPlatformConfigPda = getPlatformConfigPda;
exports.getPlatformFeeVaultPda = getPlatformFeeVaultPda;
exports.getProgram = getProgram;
exports.getProgramId = getProgramId;
exports.getProjectConfigPda = getProjectConfigPda;
exports.getProjectPdas = getProjectPdas;
exports.getQuoteTokenVaultPda = getQuoteTokenVaultPda;
exports.getRegistryPda = getRegistryPda;
exports.getUserAta = getUserAta;
exports.getUserMigrationPda = getUserMigrationPda;
exports.getWsolVaultPda = getWsolVaultPda;
exports.isProjectActive = isProjectActive;
exports.isProjectPaused = isProjectPaused;
